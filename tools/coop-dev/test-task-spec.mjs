...
const fixturesDir = path.join(repoRoot, 'docs', 'coop', 'fixtures', 'task-spec-v1')
const validator = path.join(repoRoot, 'tools', 'coop-dev', 'validate-task.mjs')
...
const fixtures = entries.filter((name) => name.endsWith('.md')).sort()
